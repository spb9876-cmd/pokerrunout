...
export const VENUES = [
  {
    ...
    config: {
      ...
      mood: 'early',
      villains: [
        { name: 'Uncle Ray', avatar: '🍺', type: 'station', stack: 50 },
        { name: 'Sam', avatar: '🧢', type: 'abc', stack: 50 },
        { name: 'Priya', avatar: '🍿', type: 'recreational', stack: 50 },
      ],
    },
  ...
  },
  {
    ...
    config: {
      ...
      mood: 'swing',
      villains: [
        { name: 'Dave', avatar: '😏', type: 'tricky', stack: 100 },
        { name: 'Marcus', avatar: '🕶️', type: 'lag', stack: 100 },
        { name: 'Jenny', avatar: '🔒', type: 'nit', stack: 100 },
        { name: 'Big Tony', avatar: '🍕', type: 'station', stack: 100 },
      ],
    },
  ...
  },
  {
    ...
    config: {
      ...
      bigBlind: 2,
      villains: [
        { name: 'Vic', avatar: '💼', type: 'tag', stack: 200 },
        { name: 'The Tourist', avatar: '🌴', type: 'recreational', stack: 200 },
        { name: 'Earl', avatar: '🪨', type: 'station', stack: 300 },
        { name: 'Headphones Kid', avatar: '🎧', type: 'lag', stack: 200 },
        { name: 'Doris', avatar: '👵', type: 'nit', stack: 150 },
      ],
    },
  ...
  },
  {
    ...
    config: {
      ...
      freshTable: true,
      villains: [
        { name: 'xX_r1verG0d_Xx', avatar: '🌊', type: 'unknown', stack: 100 },
        { name: 'FoldEquityFan', avatar: '📐', type: 'unknown', stack: 100 },
        { name: 'chip_sandwich', avatar: '🥪', type: 'unknown', stack: 100 },
        { name: 'AA_every_hand', avatar: '🎰', type: 'unknown', stack: 100 },
        { name: 'quietgrinder', avatar: '🤫', type: 'unknown', stack: 100 },
      ],
    },
  ...
  },
  {
    ...
    config: {
      ...
      bigBlind: 5,
      villains: [
        { name: 'Sonny', avatar: '🕴️', type: 'tag', stack: 500 },
        { name: 'The Doctor', avatar: '🩺', type: 'tricky', stack: 500 },
        { name: 'Lena', avatar: '🦈', type: 'lag', stack: 700 },
        { name: 'Whale Watch', avatar: '🐳', type: 'recreational', stack: 500 },
      ],
    },
  ...
  },
  {
    ...
    config: {
      ...
      mood: 'late',
      villains: [
        { name: 'Ivan', avatar: '🐻', type: 'maniac', stack: 1500 },
        { name: 'The Judge', avatar: '⚖️', type: 'tricky', stack: 1000 },
        { name: 'Cal', avatar: '🥃', type: 'lag', stack: 1000 },
        { name: 'Moneybags', avatar: '💰', type: 'station', stack: 2000 },
      ],
    },
